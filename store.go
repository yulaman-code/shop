...
func seedProducts() {
	...
	demo := []Product{
		{Title: "Механическая клавиатура", Description: "Компактная клавиатура с тактильными переключателями", Price: 6500, ImagePath: "/static/images/keyboard.png", Stock: 12},
		{Title: "Беспроводные наушники", Description: "Активное шумоподавление, до 30 часов работы", Price: 9200, ImagePath: "/static/images/headphones.png", Stock: 8},
		{Title: "Настольная лампа", Description: "Регулируемая яркость, USB-зарядка", Price: 2300, ImagePath: "/static/images/lamp2.png", Stock: 20},
		{Title: "Рюкзак для ноутбука", Description: "Влагостойкий, отделение под 15-дюймовый ноутбук", Price: 3400, ImagePath: "/static/images/backpack2.png", Stock: 15},
		{Title: "Термокружка", Description: "Держит тепло 6 часов, объём 450мл", Price: 1200, ImagePath: "/static/images/mug2.png", Stock: 30},
		{Title: "Настольный органайзер", Description: "Дерево, 5 отделений", Price: 1800, ImagePath: "/static/images/organizer.png", Stock: 0},
	}
